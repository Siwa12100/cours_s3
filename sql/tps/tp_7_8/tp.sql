...
-- A tester...
-- SELECT bs.idPlayer, bs.points, bs.idGame
-- FROM BestScorer bs
-- WHERE bs.idGame = (
--     SELECT g.id
--     FROM Game g
--     WHERE g.dateGame = '2006-01-22'::date
--     AND g.idHomeTeam = '1610612747'
--     AND g.idVisitorTeam = '1610612761'
-- );

-- On cherche l'id du match en question :
--  SELECT g.id
--     FROM Game g
--     WHERE g.dateGame = '2006-01-22'::date
--     AND g.idHomeTeam = '1610612747'
...
-- SELECT bs.idPlayer, bs.idGame
-- FROM BestScorer bs
-- WHERE bs.idGame = '20500591';

-- SELECT *  FROM BestScorer;
-- SELECT count(*) FROM BestScorer;

-- SELECT COUNT(*)
-- FROM (SELECT DISTINCT gd.idGame
-- FROM GameDetail gd) l;
